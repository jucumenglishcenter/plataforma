  ...
  return (
    <>
      ...
      {view === 'modules'  ? <ManageModules onBack={() => setView('modules')} />
       ...
       : view === 'exams'    ? (window.ExamsCenter ? <ExamsCenter canDefine onBack={() => setView('exams')} /> : window.TeacherExamsFolders ? <TeacherExamsFolders canDefine onBack={() => setView('exams')} /> : <TeacherExams canDefine onBack={() => setView('exams')} />)
